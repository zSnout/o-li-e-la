...
export function Slide(props: { children: JSXElement; class?: string }) {
  ...
  return (
    <div
      class={
        "fixed left-1/2 top-1/2 m-auto h-[540px] w-[960px] origin-center -translate-x-1/2 -translate-y-1/2 scale-[--scale] bg-white [--scale:1]" +
...
export function SlideWithVocab(props: { main: JSXElement; vocab: JSXElement }) {
  return (
    <Slide class="grid grid-cols-[2fr,1fr] p-4">
      <main class="flex flex-col p-4 pr-8">{props.main}</main>
